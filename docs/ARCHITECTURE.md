...
> [Acuven_Central_AI_Billing_Platform_Spec_v1.3.md](Acuven_Central_AI_Billing_Platform_Spec_v1.3.md) 为准，括号里的 §N 是 spec 节号。
> 最后更新：2026-09-10
...
任何实现都必须保住这 14 条。**建议写进 PR 模板逐条勾选。**
...
前端与 integration-client 的目录在对应 Phase 再定。**§101 视为已被本节取代**，实现时不要再回去照抄。
