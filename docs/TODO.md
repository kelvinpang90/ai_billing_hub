...
- [ ] spec 瘦身（通读已完成，估计可减约 800 行 / 16.4%，剩约 4070 行）。**删除类 ≈330 行**：§138（编造数字的界面草图，零外部引用）、§137、§102 目录树（文档自称非规范）、§120（逐条被 §95 覆盖）、§85、§71/§72、§139 上半、§134 步骤块、§56/§58/§59 导航清单。**压缩类 ≈400 行**：同一条异步流程图在 §2/§20/§22/§103 画了 4 遍（主场 §20，唯一带 `REQ-INGEST-001/002`）、§55–§73 的表格列与筛选器清单（筛选维度出现 4 次）、§135 压成交叉引用（Rule 3–8 是真约束但每条都复述别处）。**另有 3 处待核实的矛盾**：§28 的 `>` vs §30 的 `>=`（且 §30 断言二者同规则）、§55 旧词「Actual AI Provider Cost」、§30 的「示例 5 分钟」vs §119 的硬上界。**未做**，另开 PR
