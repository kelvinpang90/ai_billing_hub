...
- [ ] **R6 — 仓库可见性偏离未收口**：spec §99 要求私有仓库，实际是公开（为在 GitHub Free 上拿到分支保护）。二选一：升级 Pro 转回私有，或写 ADR + 修订 spec 至 v1.2 让 §99 与实际一致。详见 [ARCHITECTURE.md](ARCHITECTURE.md) 第 7.1 节。**收口前不得进入生产部署。**（来源：Codex 审查 PR #2）
